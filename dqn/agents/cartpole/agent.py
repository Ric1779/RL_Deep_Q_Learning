...
from agents.cartpole.model import DQN
from replay_memory import ReplayMemory, Sample
from agents.cartpole.config import CartPoleConfig
from agents.base_agent import BaseAgent
from agents.cartpole.utils import preprocess_observation, preprocess_sampled_batch
...
class CartPoleAgent(BaseAgent):
    ...
    def train(self) -> None:
        ...
        for episode in range(self.cfg.train.episodes):
            ...
            obs = preprocess_observation(self.env.reset()[0])
            steps = 0
            while not done:
